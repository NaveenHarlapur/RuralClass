  ...
  if (isLoading) {
    return (
      <div className="flex min-h-screen flex-col items-center justify-center gap-4 bg-background">
        ...
        <p className="text-muted-foreground animate-pulse">Loading Student Dashboard...</p>
      </div>
    );
  }
  ...
  if (!user) {
    return (
      <div className="flex min-h-screen flex-col items-center justify-center gap-4 bg-background text-center px-4">
        ...
        <p className="text-muted-foreground">Please sign in to access the student dashboard.</p>
